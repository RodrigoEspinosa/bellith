...
final class StatusBarViewTests: XCTestCase {
    func testGitHubToolTipIncludesPullRequestsAndIssues() {
        let details = GitHubService.StatusDetails(
            ...
            openIssues: 1,
            pullRequests: [
                .init(number: 12, title: "Improve status bar", author: "rec", labels: [], isDraft: false, headBranch: "feat/status-bar", createdAt: "1h ago", url: "https://example.com/pr/12"),
                .init(number: 15, title: "Add loading state", author: "bot", labels: [], isDraft: false, headBranch: "feat/loading", createdAt: "2h ago", url: "https://example.com/pr/15"),
            ],
            issues: [
